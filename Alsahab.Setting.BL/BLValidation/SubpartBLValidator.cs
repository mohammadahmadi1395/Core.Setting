...
{
    internal class SubpartBLValidator : BaseBLValidator<Subpart, SubpartDTO, SubpartFilterDTO>//: Alsahab.Setting.DTO.SubpartValidator
    {
        private readonly IBaseDL<Subpart, SubpartDTO, SubpartFilterDTO> _SubpartDL;
        public SubpartBLValidator(IBaseDL<Subpart, SubpartDTO, SubpartFilterDTO> subpartDL) : base(subpartDL)
        {
