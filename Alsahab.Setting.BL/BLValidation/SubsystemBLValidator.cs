...
{
    internal class SubsystemBLValidator : BaseBLValidator<Subsystem, SubsystemDTO, SubsystemFilterDTO>//Alsahab.Setting.DTO.SubsystemValidator
    {
        private readonly IBaseDL<Subsystem, SubsystemDTO, SubsystemFilterDTO> _SubsystemDL;
        public SubsystemBLValidator(IBaseDL<Subsystem, SubsystemDTO, SubsystemFilterDTO> subsystemDL) : base(subsystemDL)
        {
