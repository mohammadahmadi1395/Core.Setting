...
{
    internal class BLOrganizationTypeValidator : Alsahab.Setting.DTO.Validation.OrganizationTypeValidator
    {
        TypeoforganizationBL BLTypeoforganizationBL = new TypeoforganizationBL();
